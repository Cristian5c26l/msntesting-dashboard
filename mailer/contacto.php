...
switch ($subject) {
    case '1':
        $emailSubject = "Ticket Realizado | ".$comment;
    break;
    case '2':
        $name = $_POST['name'];
    ...
    break;
    case '3':
        $emailSubject = "Ticket Reabierto | ".$comment;
    break;
    case '4':
        $emailSubject = "Ticket Detenido o en Espera de otra Área | ".$comment;
    break;    
    default: 
        # code...
    break;
...
try{
    ...
    $mail->AddAddress($email, 'Contacto Ticket');
    //$mail->AddAddress($email2, ' ');
    //$mail->AddAddress($email3, ' ');
    $mail->AddAddress('developer@rand.com.mx', 'WM');
    $mail->Subject = $emailSubject;
    $mail->isHTML(true);
    $mail->MsgHTML('Notificación de Ticket');
