...
<div class="card">
    ...
    <div class="card card-body p-2">
        <div class="row row-projects">
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <h4 class="mb-0 "><?php echo $supportInstance->numTickets(0,0,16); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <i class="material-icons text-grey md-36">warning</i>
                <div class="mb-1">Tickets Inmediatos</div>
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(1,"",16); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
            ...
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(2,"",16); ?></h4>
            </div>
        </div>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <?php echo $supportInstance->selectAllTickets(0,16); ?>
            </tbody>
        </table>
    </div>
</div>
