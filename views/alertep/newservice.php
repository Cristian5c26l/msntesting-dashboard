...
?>
<div class="card">
    <h2 class="">Categorías de Alertas Estados Procesales</h2>
...
<div class="card">
    <div class="card-header">
        <h2 class="card-title">Mis Categorías de Alerta</h2>
    </div>
