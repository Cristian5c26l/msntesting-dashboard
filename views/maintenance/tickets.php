...
<div class="card">
    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <?php echo $supportInstance->selectAllTickets(0,11); ?>
            </tbody>
        </table>
    </div>
</div>
