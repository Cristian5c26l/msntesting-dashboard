...
<div class="card">
    ...
    <div class="card card-body p-2">
        <div class="row row-projects">
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <h4 class="mb-0 "><?php echo $supportInstance->numTickets(0,0,3); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <i class="material-icons text-grey md-36">warning</i>
                <div class="mb-1">Tickets Inmediatos</div>
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(1,0,3); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <i class="material-icons text-success md-36">assistant_photo</i>
                <div class="mb-1">Tickets Terminados</div>
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(0,1,3); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <i class="material-icons text-danger md-36">alarm</i>
                <div class="mb-1">Tickets Urgentes</div>
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(2,0,3); ?></h4>
            </div>
        </div>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <?php echo $supportInstance->selectAllTickets(0,3); ?>
            </tbody>
        </table>
    </div>
</div>
