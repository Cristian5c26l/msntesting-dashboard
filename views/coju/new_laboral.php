...
<div class="card">
    <h2 class="">CONTROL INTERNO (CI) Laboral</h2>
    <?php 
        ...
        if($type==4){
            ...
            $btn_add_coju=  '<div class="btn btn-outline-primary" data-toggle="collapse" data-target="#addTurn" aria-expanded="false" aria-controls="addUser">
                                ...
                                Agregar CONTROL INTERNO (CI) Laboral
                            </div>';
            $disabled = "disabled";                
        }
        echo $btn_add_coju;       
    ...
    <div class="collapse" id="addTurn">
        <div class="card card-body">
            <form class="row" onsubmit="newCojuLaboral(); return false;">
...
<div class="card">
    <div class="card-header">
        <h2 class="card-title">CONTROL INTERNO (CI) Laboral</h2>
    </div><br>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form class="form-group col-lg-12 row" onsubmit="cojuRespLaboral(); return false;">
                    <div class="form-group col-lg-8">
