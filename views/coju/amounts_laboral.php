<?php
    if($_REQUEST['id']){
        ...
        include '../../controllers/coju_laboral.php';
        include '../../models/coju_laboral.php';
        ...
        <div class="card">
            ...
            <div class="collapse" id="addAct">
                <div class="card card-body">
                    <form class="row" onsubmit="addActLaboral(); return false;">
            ...
            <div class="collapse" id="addAmount">
                <div class="card card-body">
                    <form class="row" onsubmit="addAmountLaboral(); return false;">
                        <div class="form-group col-lg-4">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form class="form-group col-lg-12 row" onsubmit="editAmountLaboral(); return false;">
...
<div class="modal fade" id="largeModal2" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel2" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form class="form-group col-lg-12 row" onsubmit="editActLaboral(); return false;">
                    <div class="col-lg-12 row">
                        <div class="form-group col-lg-6">
