    ...
    <div class="card card-body p-2">
        <div class="row row-projects">
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <h4 class="mb-0 "><?php echo $supportInstance->numTickets(0,0,1); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <i class="material-icons text-grey md-36">warning</i>
                <div class="mb-1">Inmediate Tickets</div>
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(1,0,1); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <i class="material-icons text-success md-36">assistant_photo</i>
                <div class="mb-1">Done Tickets</div>
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(0,1,1); ?></h4>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <i class="material-icons text-danger md-36">alarm</i>
                <div class="mb-1">Urgent Tickets</div>
                <h4 class="mb-0"><?php echo $supportInstance->numTickets(2,0,1); ?></h4>
            </div>
        </div>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered table-dark" style="width:100%">
            ...
            <tbody>
                <?php echo $supportInstance->selectAllTickets(0,1); ?>
            </tbody>
        </table>
    </div>
</div>
