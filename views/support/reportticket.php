...
?>
<div class="card">
    <h2 class="">Reporte de Tickets</h2>

    <div class="card card-body">
        <form class="row" onsubmit="reportticket(); return false;"> 
            ...
            <div class="form-group col-lg-3">
                <select id="area" class="form-control">
                    ...
                    <?php echo $ticketInstance->selectTicketArea();?>
                </select>
            </div>
            <div class="form-group col-lg-3">
...
<div class="card">
    ...
    <div id="tickets" style="width: 100%; height: 500px;"></div>
