...
class m_alertep{
    ...
    public function addService($host,$user,$pass,$db,$idarea,$service,$descript){
        ...
        $sql = "INSERT INTO adm_tipo_alertas_ep (idarea,service,description,date_ini,status) values($idarea,'$service','$descript','$time',2)";
    ...
    public function editservice($host,$user,$pass,$db,$id,$idarea,$service,$descript){
        ...
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "UPDATE adm_tipo_alertas_ep SET idarea=$idarea, service='$service', description='$descript' WHERE id=$id ";
    ...
    public function delService($host,$user,$pass,$db,$id){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "UPDATE adm_tipo_alertas_ep SET status = 0 WHERE id=$id " ;
    ...
    public function selectUserService($host,$user,$pass,$db){
        ...
        $sql = "SELECT S.*, A.area, A.status, Es.name as nstats FROM adm_tipo_alertas_ep as S 
    ...
    public function selectService($host,$user,$pass,$db,$id){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "SELECT S.*, A.area, A.status as nstats FROM adm_tipo_alertas_ep as S
    ...
    public function addAlert($host,$user,$pass,$db,$idservice,$title,$comment,$date,$paytype){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "INSERT INTO adm_alertas_ep (idservice,title,comment,paytype,date_end,status) values($idservice,'$title','$comment','$paytype','$date',2)";
    ...
    public function editAlert($host,$user,$pass,$db,$id,$idservice,$title,$comment,$date,$paytype){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "UPDATE adm_alertas_ep SET idservice=$idservice,title='$title',comment='$comment',date_end='$date',paytype='$paytype' WHERE id=$id ";
    ...
    public function delAlert($host,$user,$pass,$db,$id){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "UPDATE adm_alertas_ep SET status = 0 WHERE id=$id " ;
    ...
    public function selectAlert($host,$user,$pass,$db,$id){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "SELECT * FROM adm_alertas_ep WHERE id=$id AND status>=1 ";
    ...
    public function selectUserAlert($host,$user,$pass,$db,$id,$iduser){
        ...
        $sql = "SELECT A.*, S.service, S.status, Es.name as nstats, P.name as npriority, P.class, Em.name as assignated, Em.email as email FROM adm_alertas_ep as A 
        LEFT JOIN empleados as Em ON A.idassign = Em.id
        LEFT JOIN adm_tipo_alertas_ep as S ON A.idservice = S.id
    ...
    public function selectAlertService($host,$user,$pass,$db){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "SELECT * FROM adm_tipo_alertas_ep WHERE status>=1";
    ...
    public function editStatusAlert($host,$user,$pass,$db,$id,$status){
        $con = $this->connect($host,$user,$pass,$db);
        $sql = "UPDATE adm_alertas_ep SET status = $status WHERE id=$id";
    ...
    public function assignpriority($host,$user,$pass,$db,$id,$idTask){
        $con = $this->connect($host,$user,$pass,$db);
        $sql ="UPDATE adm_tareas_ep SET priority = $id WHERE id = $idTask ";
    ...
    public function numAlert($host,$user,$pass,$db,$status,$idservice){
        ...
        $sql = "SELECT COUNT(*) as num FROM adm_alertas_ep $ext";
    ...
    public function assignAlert($host,$user,$pass,$db,$id,$idAlert){
        $con = $this->connect($host,$user,$pass,$db);
        $sql ="UPDATE adm_alertas_ep SET idassign = $id WHERE id = $idAlert ";
    ...
    public function updateDate($host,$user,$pass,$db,$id,$newDate){
        $con = $this->connect($host,$user,$pass,$db);
        $sql ="UPDATE adm_alertas_ep SET date_end = '$newDate' WHERE id = $id ";
