...
class m_phone{
    ...
    public function addPhone($host,$user,$pass,$db,$iduser,$ubication,$phone,$ext){
        ...
        $sql = "INSERT INTO adm_ext (iduser,idubication,phone,ext) VALUES($iduser,$ubication,'$phone','$ext')"; 
    ...
    public function editPhone($host,$user,$pass,$db,$id,$iduser,$ubication,$phone,$ext){
        ...
        $sql = "UPDATE adm_ext SET iduser=$iduser, idubication=$ubication, phone='$phone', ext='$ext' WHERE id='$id' "; 
