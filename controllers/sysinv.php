...
class c_sysinv{
    ...
    public function selectInsumeType(){
        ...
        while($row = mysqli_fetch_array($res)){
            ...
            ?>
                ...
                <option value="<?php echo $id; ?>"><?php echo $id.'- '.$insume; ?></option>
    ...
    public function selectSize(){
        ...
        while($row = mysqli_fetch_array($res)){
            ...
            ?>
                ...
                <option value="<?php echo $id; ?>"><?php echo $id.'- '.$storage; ?></option>
    ...
    public function selectMark(){
        ...
        while($row = mysqli_fetch_array($res)){
            ...
            ?>
                ...
                <option value="<?php echo $id; ?>"><?php echo $id.'- '.$mark; ?></option>
    ...
    public function selectMarksByInsumeType($insTypeId){

        $res = $this->model->selectMarksByInsumeType($this->host,$this->user,$this->pass,$this->db, $insTypeId);
    ...
    public function selectUbication(){
        ...
        while($row = mysqli_fetch_array($res)){
            ...
            ?>
                ...
                <option value="<?php echo $id; ?>"><?php echo $id.'- '.$ubication; ?></option>
