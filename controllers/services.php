...
class c_service{
    ...
    public function __construct($host,$user,$pass,$db)
    {
        ...
        $this->pass = $pass;
        $this->db = $db;
        $this->model = $model = new m_service();
    }
                ...
                <tr>
                    ...
                    <td>
                        <div class="table-buttons">
                            ...
                            ?>
                            <button onclick="editableService('<?php echo $id; ?>')" type="button" class="btn btn-outline-primary btn-sm" <?php echo $disabled; ?>>
                                <i class="material-icons md-14 align-middle mb-1 text-primary">edit</i>
                            </button>    
                            <button onclick="delService('<?php echo $id; ?>')" type="button" class="btn btn-outline-danger btn-sm" <?php echo $disabled; ?>>
                                <i class="material-icons md-14 align-middle mb-1 text-danger">delete</i>
                            </button>
                            <button onclick="detailService('<?php echo $id; ?>')" type="button" class="btn btn-outline-stoped btn-sm" <?php echo $disabled; ?>>
    ...
    public function selectService($id,$type=null){
        ...
        if($type==1){
            ...
            $description = $row['description'];
                ...
                ?>
                    <form class="row" onsubmit="editService(<?php echo $id; ?>); return false;">
    ...
    public function selectAlert($id,$type=null){
        ...
        if($type==1){
            ...
            $date_end = $row['date_end'];
                ...
                ?>
                    <form class="row" onsubmit="editAlert(<?php echo $id; ?>); return false;">
                        <div class="form-group col-lg-12">
                    ...
                    <td class="<?php echo $tdclass; ?>">
                        <div class="table-buttons">
                            ...
                            <div class="dropdown-menu">
                                <div onclick="editStatusAlert('<?php echo $id; ?>',2,1,'<?php echo $period; ?>');" class="dropdown-item">Pagado</div>
                                <div onclick="editStatusAlert('<?php echo $id; ?>',2,2,'<?php echo $period; ?>');" class="dropdown-item">Reabrir</div>
                                <div onclick="editStatusAlert('<?php echo $id; ?>',7,3,'<?php echo $period; ?>');" class="dropdown-item">Detenido</div>
                            </div>
                            ...
                            <button onclick="editableAlert('<?php echo $id; ?>')" type="button" class="btn btn-outline-primary btn-sm" <?php echo $disabled; ?>>
                                <i class="material-icons md-14 align-middle mb-1 text-primary">edit</i>
                            </button>    
                            <button onclick="delAlert('<?php echo $id; ?>')" type="button" class="btn btn-outline-danger btn-sm" <?php echo $disabled; ?>>
                                <i class="material-icons md-14 align-middle mb-1 text-danger">delete</i>
                            </button>
                            <?php
                            }
    ...
    public function selectAllStatus($idService){
        ...
        while($row = mysqli_fetch_array($res)){
            ...
            ?>
                <div id="<?php echo $id; ?>" onclick="assignPriorityAlert('<?php echo $idService; ?>','<?php echo $id; ?>','<?php echo $priority; ?>');" class="dropdown-item"><?php echo $priority; ?></div>
            <?php
        }
    }
